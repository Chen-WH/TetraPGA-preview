...
- TetraPGA faster: 7 / 13
- Pinocchio faster: 6 / 13

Results:

| category | TetraPGA op | TetraPGA ns | Pinocchio op | Pinocchio ns | speedup | faster |
| --- | --- | ---: | --- | ---: | ---: | --- |
| adjoint_inverse_matrix | `ga_AdM_matrix` | 10.063 | `SE3_toActionMatrixInverse` | 19.902 | 1.98x | TetraPGA |
| adjoint_matrix | `ga_rbm_matrix` | 10.108 | `SE3_toActionMatrix` | 14.729 | 1.46x | TetraPGA |
| commutator_direct | `ga_com` | 3.834 | `Motion_cross` | 9.036 | 2.36x | TetraPGA |
| commutator_matrix | `ga_com_matrix` | 8.012 | `Motion_toActionMatrix` | 11.429 | 1.43x | TetraPGA |
| exp_map | `ga_exp` | 17.174 | `exp6` | 24.400 | 1.42x | TetraPGA |
| force_transform | `ga_rbm` | 13.955 | `SE3_act_Force` | 4.594 | 0.33x | Pinocchio |
| inertia_transform | `rbm_I_AdM` | 50.743 | `SE3_act_Inertia` | 7.711 | 0.15x | Pinocchio |
| log_map | `ga_log` | 9.371 | `log6` | 106.951 | 11.41x | TetraPGA |
| motion_inverse_transform | `ga_AdM` | 14.115 | `SE3_actInv_Motion` | 4.974 | 0.35x | Pinocchio |
| motion_transform_direct | `ga_rbm` | 13.854 | `SE3_act_Motion` | 4.408 | 0.32x | Pinocchio |
| motor_compose | `ga_mul` | 8.549 | `SE3_multiply` | 7.684 | 0.90x | Pinocchio |
| motor_inverse | `ga_rev` | 3.423 | `SE3_inverse` | 3.718 | 1.09x | TetraPGA |
| point_transform | `pga_rbm3` | 38.985 | `SE3_act_Vector3` | 6.322 | 0.16x | Pinocchio |
