#!/usr/bin/env python3
"""Apply temporary GA preview plotting tweaks to the MATLAB figure script."""
...
TARGETS = [
    Path("/home/chenwh/Documents/GA-OCP/AAA_cpp_mpc_bench.m"),
    Path("/home/chenwh/ros2_ws/src/TetraPGA-preview/reviewer_revision_experiments/04_closed_loop_mpc_metrics/AAA_cpp_mpc_bench.m"),
]


SCRIPT = r'''%% Reference tracking figure (bar version with mean-to-p95 line)
